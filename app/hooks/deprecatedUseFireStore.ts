...
//           if (tree.user_id) {
//             const owner = await getByDocumentId<User>('users', tree.user_id);
...
//     getAccountByCode: (code: string) => getByDocumentId<Account>('accounts', code),
...
//       const rel = await getByDocumentId<RelTreeFertilization>('rel_tree_fertilizations', id);
//       if (rel) {
